  ...
  return (
    <div className="w-full rounded-lg bg-light border-2 border-dark shadow-md flex flex-col">
      <div className="p-4 flex justify-between items-start border-b border-gray-800">
        <div>
          <h3 className="font-medium text-md md:text-xl text-dark">
            {task.title}
          </h3>
        </div>
        <TasksActions
      ...
      <div className="p-4 text-dark/80 w-full text-sm md:text-base">
        <p>{task.description}</p>
      </div>
      <section className="px-4 py-3 bg-light flex flex-col gap-2 mt-auto rounded-b-lg">
        <div className="flex items-center text-dark justify-between">
          <div className="flex gap-2 items-center">
            <i
              ...
              aria-hidden="true"
            />
            <span className="text-dark/50 text-sm md:text-base">
              {formatDate(task.due_date.toString())}
            </span>
          </div>
          <span
            className={`flex items-center px-3 py-1.5 rounded-full text-sm md:text-base gap-2 text-nowrap ${statusColor}`}
          >
        ...
        {task.user_id && (
          <section className="flex items-center gap-2 text-right">
